...
export default function GitHubProfileViewer() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-8 bg-gray-500">
      <Card className="w-full max-w-3xl p-6 space-y-4 rounded-lg bg-gray-900 shadow-md shadow-white text-white
      ">
        <CardHeader className="text-center">
          <CardTitle className="text-3xl text-sky-300 font-bold mb-2">
            GitHub Profile Viewer App
          </CardTitle>
          <CardDescription className="text-gray-400">
            Search for a GitHub username and view their profile and
            repositories, search like: Yusra-Saleem
          </CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit} className="mb-8 px-6">
          <div className="flex items-center gap-4">
            <Input
              ...
              className="flex-1shaow-sm shadow-white text-black border-2 hover:shadow-md  hover:shadow-sky-400 rounded-md p-2"
            />
            <Button
              type="submit"
              disabled={loading}
              className="px-4 py-2 bg-gray-600 border  border-white shadow-sm shadow-white hover:shadow-sky-400 hover:shadow-md text-white rounded-md"
            >
        ...
        {userProfile && (
          <div className="grid gap-8 px-6">
            ...
            <div className="grid md:grid-cols-[120px_1fr] gap-6">
              <Avatar className="w-30 h-30 shadow-md shadow-sky-400 border">
            ...
            <div className="grid gap-6">
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-2 gap-6">
                {userRepos.map((repo) => (
                  <Card
                    key={repo.id}
                    className="rounded-lg border shadow-md hover:shadow-lg hover:shadow-white text-white shadow-sky-500 bg-[#0b1738]"
                  >
                    <CardHeader>
                      <div className="flex items-center gap-2">
                    ...
                    <CardFooter className="flex items-center justify-between">
                      ...
                      <Link
                        href={repo.html_url}
                        target="_blank"
                        className="hover:underline hover:text-sky-500  text-white"
                        prefetch={false}
                      >
                        View on GitHub
                      </Link>
